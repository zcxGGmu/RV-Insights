...
### 并行运行的商业版本
同时 RV-Insights 也支持商业的版本，如果你需要未来更多的**云端功能**｜**稳定靠谱的 API** ｜**更划算省心的订阅包**｜**简单的使用体验**，也欢迎支持 RV-Insights 的商业版本：https://proma.cool/download 即可下载使用，订阅包低至官方价 4 折。
...
### Chat 模式
RV-Insights 的聊天模式，支持多模型切换，支持附加文件对话。
